...
function Events() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex flex-col items-center mt-10 px-2 md:px-4 mb-20 space-y-8">
      ...
      {/* Static IDEATHON 2025 Event */}
      <div className="w-full bg-white shadow-xl rounded-2xl overflow-hidden mb-8">
        <img className="w-full h-[450px]" src={image} alt="IDEATHON 2025" />
        <div className="p-6">
          <h3 className="text-3xl font-bold mb-2 text-gray-800">IDEATHON 2025</h3>
          ...
          <div className="text-md text-gray-500 mb-4">
            📅 2025-04-17 &nbsp; 📍 TPIC, HNBGU, Srinagar, UK
          </div>
        </div>
      </div>
      ...
      {events.length === 0 ? (
        ...
        events.map((event) => (
          ...
          >
            {event.image && (
              <img className="w-full h-[450px]" src={event.image} alt={event.title} />
            )}
            <div className="p-6">
